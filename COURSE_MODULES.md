...
[`05 - Reading, Writing, and Schemas/README.md`](05%20-%20Reading%2C%20Writing%2C%20and%20Schemas/README.md#before-notebook-01).
...
| 8 | Aggregations and Window Functions | Produce analytics-ready summaries and KPI tables | `groupBy` and window functions; pivot; Top-N per group; sampling; KPI folders under `curated/` | Module 7 | Analytics and reporting layers | Produces KPI/metric tables for the project | Started |
