...
| 2 | DataFrame Fundamentals | Build and inspect DataFrames | Creating DataFrames, schemas, `select`/`withColumn`, inspecting structure | Module 1 | Core API fluency used in every notebook | Forms the DataFrame layer reused throughout | Current |
