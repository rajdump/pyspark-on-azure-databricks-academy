...
| 3 | NULL Semantics and Predicate Correctness | Reason correctly about NULLs and three-valued logic in predicates | Three-valued logic, NULL in filters and joins, reusable quality predicates (builds on Module 2 filtering intro) | Module 2 | Correctness in data-quality-sensitive logic | Provides NULL-safe filtering/cleaning logic used downstream | Not Started |
| 4 | Transformations, Actions, and Lazy Evaluation | Understand Spark's lazy execution model on chains learners already write | Transformations vs. actions, the query plan, narrow vs. wide operations | Modules 2–3 | Builds performance-aware coding habits early | Shapes how pipeline logic is written efficiently | Not Started |
| 5 | Data Cleaning and Type Handling | Handle messy, real-world data | Missing/blank/sentinel values, type casting depth, numeric overflow, date/timestamp parsing | Modules 3–4 | Robust ingestion preparation | Produces the raw-to-clean transforms the project depends on | Not Started |
