...
# MAGIC %md
# MAGIC **`like(pattern)`** matches a SQL text pattern — **`%`** matches any sequence
# MAGIC (including none); **`_`** matches exactly one character. The pattern **`S%`**
# MAGIC keeps service types that start with **`S`**.
