...
# MAGIC
# MAGIC Next up: **Module 3 — Transformations, Actions, and Lazy Evaluation** —
# MAGIC why Spark waits to run work until an action, and how that affects the chains
# MAGIC you already write.
