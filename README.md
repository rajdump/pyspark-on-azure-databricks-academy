...
- **Authoring status (current):** Modules 1–7 are complete; active authoring is **Module 8 — Aggregations and Window Functions** — design: [`08 - Aggregations and Window Functions`](08%20-%20Aggregations%20and%20Window%20Functions/README.md); status source: [`COURSE_MODULES.md`](COURSE_MODULES.md)
