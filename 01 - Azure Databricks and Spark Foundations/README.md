...
| 2 | Apache Spark Architecture and PySpark | Why Spark distributes work; PySpark ↔ Spark; `SparkSession`; driver/executors; jobs → stages → tasks; `spark.range(...).count()` stand-in; Spark UI on classic all-purpose Standard |
